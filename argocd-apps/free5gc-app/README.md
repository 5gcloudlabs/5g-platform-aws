...
- The repository serves as the centralized source for manifests, but there is **no continuous synchronization** from Git — updates are applied manually or through controlled automation workflows.  
