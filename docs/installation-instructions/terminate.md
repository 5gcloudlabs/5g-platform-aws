...
Tear down the platform environment when it is not in use to stop ongoing AWS charges (approximately USD 3.50–4.00/hour in usage, ~USD 4.50/hour including applicable taxes while the environment is running).
