...
envsubst <  /git-repo/argocd-apps/free5gc-app/free5gc-app.base > /tmp/free5gc-app.yml 
envsubst '$mcc,$mnc' < /git-repo/scripts/ui/subscriber-provisioner-ui.base > /tmp/subscriber-provisioner-ui.sh
envsubst '$mcc,$mnc' < /git-repo/argocd-apps/ueransim-app/ueransim-app.base > /tmp/ueransim-app.tmp
